...
var BaseType = [Number, String, Boolean, Array, Symbol, Function];
...
var paramTypeCheck = function paramTypeCheck(value, index, type, ext) {
...
var returnTypeCheck = function returnTypeCheck(value, type, ext) {
  (0, _newArrowCheck2["default"])(this, _this);
  var cType = typeOf(value);
...
var setPropertyTypeCheck = function setPropertyTypeCheck(target, name, type, ext) {
  (0, _newArrowCheck2["default"])(this, _this);
...
var propertyTypeCheck = function propertyTypeCheck(target, type, name, descriptor, ext) {
  (0, _newArrowCheck2["default"])(this, _this);
  return {
    enumerable: true,
    configurable: true,
...
var typeCheck = function typeCheck(type, target, name) {
  ...
  return function (target, name, descriptor) {
    ...
    return _objectSpread(_objectSpread({}, descriptor), {}, {
      value: function value() {
        ...
        var result = (_descriptor$value = descriptor.value).call.apply(_descriptor$value, [this].concat(arg));
